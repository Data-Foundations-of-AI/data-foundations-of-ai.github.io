    ...
    <table class="seminar-table">
      ...
      <tbody>
        ...
        <tr class="expandable-row" onclick="toggleDetails('seminar-1')">
          ...
          <td>Ting-Wei</td>
          <td onclick="event.stopPropagation()">
            <a href="{{ '/assets/presentations/DFAI_Talk_Apr10.pdf' | relative_url }}" target="_blank" class="text-link">
              Slides
            </a>
          </td>
        </tr>
        ...
        <tr class="expandable-row" onclick="toggleDetails('seminar-3')">
          ...
          <td>Ishika</td>
          <td onclick="event.stopPropagation()">
            <a href="https://www.youtube.com/watch?v=FQ-k1ofZz4I" target="_blank" class="text-link">
              YouTube
            </a>
          </td>
        </tr>
